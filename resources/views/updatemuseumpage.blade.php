        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <form action="/museumupdate/{{$ex->id}}" method="POST" class="w3-container">
                        {{ csrf_field() }}
                        <p>
                            <label>Museum Name</label>
                            <input class="w3-input w3-hover-blue w3-animate-input " name="name" style="width:30%"type="text" value={{ $ex->name}}></p>
                            <input class="w3-input w3-hover-blue w3-animate-input " name="reception" style="width:30%"type="text" value={{ $ex->reception }}></p>
