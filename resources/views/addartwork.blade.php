    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="w3-container w3-blue">
                ...
                <form action="/addpaint" method="POST" class="w3-container">
                    {{ csrf_field() }}
...
<input id="ptext" name="type"  class ="inputhide" value="type" type="text">
<br>
<input id="postageno2" name="type" value="Sculpture" type="radio">Sculpture
<br><label class ="inputhide">Sculpture style</label>
<input id="stext" name="type" class ="inputhide" value="type" type="text">
<br>
<input id="postageno3" name="type" value="calligraphy" type="radio">calligraphy
<br><label class ="inputhide">calligraphy style</label>
<input id="ctext" name="type" class ="inputhide" value="type" type="text">
<br>
...
<br>
    <p>
                            ...
                            <input id="edateid" class="w3-input w3-hover-blue w3-animate-input " name="edate" style="width:30%"type="date"></p>
