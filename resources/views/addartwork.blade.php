...
<input id="rCondition" name="Condition" value="c" type="radio">Collection
<br>
 <select class ="inputhide" id ="cselect" name="Collection">
    <option value="store">Store</option>
    <option value="exposed">Exposed</option>

  </select>
  <br>
<input id="rCondition2" name="Condition" value="l" type="radio">Loen
<br>
    <p>
